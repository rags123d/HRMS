...
'officePhoneNo': new FormControl(null, [Validators.pattern('^[0-9-]*$')]),
'cantactNo': new FormControl(null, [Validators.required, Validators.pattern("^((\\+91-?)?[0-9]{10}|0[0-9]{2,4}-?[0-9]{5,8}|[0-9]{2,4}-[0-9]{5,8})$")]),
