...
export class AddEmployeeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.employeeForm = new FormGroup({
      ...
      'PresentAddressLandmark': new FormControl(null, [Validators.required, Validators.maxLength(100)]),
      ...
      'PermanentAddressLandmark': new FormControl(null, [Validators.required, Validators.maxLength(100)]),
  ...
  onSubmit() {
    ...
    formData.append('PresentAddressLandmark', formobj.PresentAddressLandmark)
    ...
    formData.append('PermanentAddressLandmark', formobj.PermanentAddressLandmark)
      ...
      .subscribe(
        res => {
          if (res['success'] == true) {
            ...
            this.employeeForm.controls.PresentAddressLandmark.setValue(data.PresentAddressLandmark)
            ...
            this.employeeForm.controls.PermanentAddressLandmark.setValue(data.PermanentAddressLandmark)
  ...
  selectAddress() {
    ...
    if (this.selectedAddress == true) {
      ...
      this.employeeForm.controls.PermanentAddressLandmark.setValue(this.employeeForm.value.PresentAddressLandmark)
      ...
      this.employeeForm.controls.PermanentAddressLandmark.setValue('')
