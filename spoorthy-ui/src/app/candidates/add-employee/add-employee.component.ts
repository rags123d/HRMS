...
export class AddEmployeeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.employeeForm = new FormGroup({
      ...
      'PresentAddressDistrict': new FormControl(null, [Validators.required]),
      ...
      'PermanentAddressDistrict': new FormControl(null, [Validators.required]),
  ...
  onSubmit() {
    ...
    formData.append('PresentAddressDistrict', formobj.PresentAddressDistrict ? formobj.PresentAddressDistrict : '')
    ...
    formData.append('PermanentAddressDistrict', formobj.PermanentAddressDistrict ? formobj.PermanentAddressDistrict : '')
      ...
      .subscribe(
        res => {
          if (res['success'] == true) {
            ...
            this.employeeForm.controls.PresentAddressDistrict.setValue(data.PresentAddressDistrict)
            ...
            this.employeeForm.controls.PermanentAddressDistrict.setValue(data.PermanentAddressDistrict)
  ...
  selectAddress() {
    ...
    if (this.selectedAddress == true) {
      ...
      this.employeeForm.controls.PermanentAddressDistrict.setValue(this.employeeForm.value.PresentAddressDistrict)
      ...
      this.employeeForm.controls.PermanentAddressDistrict.setValue('')
