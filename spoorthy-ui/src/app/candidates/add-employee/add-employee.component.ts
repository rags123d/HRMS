...
export class AddEmployeeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.employeeForm = new FormGroup({
      ...
      'PresentAddressCountry': new FormControl(null, [Validators.required, Validators.pattern('^[a-zA-Z ]*$'), Validators.maxLength(50)]),
      ...
      'PermanentAddressCountry': new FormControl(null, [Validators.required, Validators.pattern('^[a-zA-Z ]*$'), Validators.maxLength(50)]),
  ...
  onSubmit() {
    ...
    formData.append('PresentAddressCountry', formobj.PresentAddressCountry)
    ...
    formData.append('PermanentAddressCountry', formobj.PermanentAddressCountry)
      ...
      .subscribe(
        res => {
          if (res['success'] == true) {
            ...
            this.employeeForm.controls.PresentAddressCountry.setValue(data.PresentAddressCountry)
            ...
            this.employeeForm.controls.PermanentAddressCountry.setValue(data.PermanentAddressCountry)
  ...
  selectAddress() {
    ...
    if (this.selectedAddress == true) {
      ...
      this.employeeForm.controls.PermanentAddressCountry.setValue(this.employeeForm.value.PresentAddressCountry)
      ...
      this.employeeForm.controls.PermanentAddressCountry.setValue('')
