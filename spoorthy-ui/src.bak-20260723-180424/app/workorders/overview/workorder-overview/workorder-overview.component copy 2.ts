...
export class WorkorderOverviewComponent implements OnInit {
      ...
      .subscribe(
        res => {
          if (res['success'] == true) {
            ...
            if (type == 'Excel') {
              this.expoerExcel(title, header, subheader, data);
            }
            this.showLoaderService.stop();
          } else {
  ...
  expoerExcel(title, header, subheader, data) {
    ...
    headerRow.worksheet.mergeCells('A4:A5'); headerRow.worksheet.mergeCells('B4:B5'); headerRow.worksheet.mergeCells('C4:C5'); headerRow.worksheet.mergeCells('D4:D5'); 
    headerRow.worksheet.mergeCells('E4:E5'); headerRow.worksheet.mergeCells('F4:F5'); headerRow.worksheet.mergeCells('G4:G5'); headerRow.worksheet.mergeCells('H4:H5');
    headerRow.worksheet.mergeCells('I4:I5'); headerRow.worksheet.mergeCells('J4:J5'); headerRow.worksheet.mergeCells('K4:K5'); headerRow.worksheet.mergeCells('L4:L5'); 
    headerRow.worksheet.mergeCells('M4:M5'); headerRow.worksheet.mergeCells('N4:N5'); headerRow.worksheet.mergeCells('O4:O5'); headerRow.worksheet.mergeCells('P4:P5');
    headerRow.worksheet.mergeCells('Q4:Q5'); headerRow.worksheet.mergeCells('R4:R5'); headerRow.worksheet.mergeCells('S4:S5'); headerRow.worksheet.mergeCells('T4:T5');
    headerRow.worksheet.mergeCells('U4:AC4'); headerRow.worksheet.mergeCells('AE4:AN4'); headerRow.worksheet.mergeCells('AP4:AW4'); headerRow.worksheet.mergeCells('AD4:AD5'); 
    headerRow.worksheet.mergeCells('AO4:AO5'); headerRow.worksheet.mergeCells('AX4:AX5'); headerRow.worksheet.mergeCells('AY4:AY5');
