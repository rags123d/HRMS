...
exports.addESIPFDetails = async function (req, res) {
    ...
    var EmployeeESIPFDetail = {
        ...
        PFMemberId: value.PFMemberId,
        PFJoiningDate: value.PFJoiningDate,
        PFExitDate: value.PFExitDate,
        PensionEPSNumber: value.PensionEPSNumber,
        PFNominatedetails: value.PFNominatedetails,
