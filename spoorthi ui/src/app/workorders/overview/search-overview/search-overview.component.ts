...
export class SearchOverviewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    (<HTMLInputElement>document.getElementById("showSearch")).style.display = "block";
    (<HTMLInputElement>document.getElementById("showDetail")).style.display = "none";
  ...
  ViewDetail() {
    (<HTMLInputElement>document.getElementById("showDetail")).style.display = "block";
    this.workorderUrl = this.clientWorkOrderForm.controls.workorderName.value
  ...
  getBill(skip, limit) {
    ...
    // this.billService.getBillByWorkOrder({ id: this.workorderUrl })
    var param = {
  ...
  filterWorkOrderRole(id: any) {
    ...
    this.clientWorkOrderForm.controls.workorderName.setValue('')
    // this.clientWorkOrderForm.controls.workorderName.setValue(this.showWorkOrder[0]._id)
  }
  ...
  // this.RenewalDate = this.singleWorkOrder.RenewalDate;
